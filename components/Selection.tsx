              ...
              >
                ...
                <div className="ml-3 flex h-5 items-center">
                  <input
                    ...
                    className="h-6 w-6 rounded-full bg-zinc-600 border-zinc-600 text-emerald-500 accent-yellow-500 focus:ring-0 focus:ring-offset-0 focus:outline-none cursor-pointer focus:outline-2 focus:outline-emerald-500"
                  />
                </div>
              </span>
            ))}
