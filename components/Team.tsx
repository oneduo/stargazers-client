    ...
    <div className="space-y-6">
      ...
      >
        {people.map((person) => (
          <li
            key={person.name}
            className="rounded-lg border border-zinc-200 dark:border-zinc-800 py-5 px-6 text-center"
          >
            <div className="space-y-6 xl:space-y-10">
              <img
                ...
                alt=""
              />
              <div className="space-y-6 xl:flex xl:items-center xl:justify-between">
                ...
                <ul role="list" className="flex justify-center space-x-5">
                  <li>
                    <a
                      href={person.twitter}
                      className="text-gray-400 dark:text-gray-600 hover:text-blue-400"
                    >
                  ...
                  <li>
                    <a
                      href={person.github}
                      className="text-gray-400 dark:text-gray-600 hover:text-black dark:hover:text-white"
                    >
